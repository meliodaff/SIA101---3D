    ...
    <div className="min-h-screen bg-[#FBF0E4]">
      ...
      <main className="ml-64 pt-16 p-8">
                    ...
                    <div className="flex items-center gap-8 flex-1">
                      ...
                      <div className="min-w-32">
                        ...
                        <div className="text-gray-800 font-semibold text-lg">
                          ₱
                          {supplier.payables.toLocaleString("en-US", {
                    ...
                    <div className="flex justify-between items-center gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <img
                          ...
                          className="w-4 h-4 object-contain"
                        />
                        <p className="text-[#889D65] font-medium text-sm">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`px-4 py-2 rounded-[5px] text-xs font-semibold ${getStatusBadgeClass(
                            supplier.portalStatus
                          )}`}
                        >
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl w-full max-w-4xl mx-4 shadow-xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              {/* Modal Form */}
              <form
                onSubmit={currentSupplier ? handleUpdateSupplier : handleSubmit}
                  ...
                  <div className="flex items-center gap-6 w-full pt-8">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-lg text-[#889D65] font-semibold">
                        ...
                        <strong>
                          ₱
                          {currentSupplier.payables.toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </strong>
                      </div>
                      ...
                      <div className="bg-transparent rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                          <div className="flex border-b border-gray-100 pb-3">
                            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide w-40">
                              CURRENCY
                            </span>
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <span className="text-gray-800 text-sm">
                              {currentSupplier.contactDepartment ||
                                "Sales Marketing"}
                            </span>
                          </div>
                          <div>
                        ...
                        <div className="space-y-3">
                          <div>
                            <strong className="text-gray-800 block mb-1">
                              {currentSupplier.otherContactName ||
                                "Jared Gonzales"}
                            </strong>
                          </div>
                          <div>
                            ...
                            <span className="text-gray-800 text-sm">
                              {currentSupplier.otherContactEmail ||
                                "jaredgonzales@gmail.com"}
                            </span>
                          </div>
                          <div>
                            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide block mb-1">
                            ...
                            <span className="text-gray-800 text-sm">
                              {currentSupplier.otherContactPhone ||
                                "+63927-156-1328"}
                            </span>
                          </div>
                        </div>
                          ...
                          {products.map((product) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                <span
                                  className={`px-3 py-1 rounded-full text-xs font-semibold ${getProductStatusBadgeClass(
                                    product.status
                                  )}`}
                                >
        ...
        <ConfirmationPopup
          ...
          onConfirm={
            productToDelete ? handleDeleteProduct : handleDeleteSupplier
          }
